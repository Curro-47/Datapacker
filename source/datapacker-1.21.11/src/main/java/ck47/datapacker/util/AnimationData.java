    ...
    public static final Codec<AnimationData> CODEC =
        RecordCodecBuilder.create(
            instance -> instance.group(
                Identifier.CODEC.fieldOf("animPath").forGetter((AnimationData ad) -> ad.animPath),
                Codec.INT.fieldOf("duration").forGetter((AnimationData ad) -> ad.duration),
                Codec.BOOL.fieldOf("loop").forGetter((AnimationData ad) -> ad.loop),
                Codec.INT.fieldOf("loop_start").forGetter((AnimationData ad) -> ad.loop_start),
                Codec.unboundedMap(Codec.STRING, AnimationBone.CODEC).fieldOf("bones").forGetter((AnimationData ad) -> ad.bones)
