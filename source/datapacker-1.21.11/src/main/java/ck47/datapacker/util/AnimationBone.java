...
public class AnimationBone {
    ...
    public static final Codec<AnimationBone> CODEC =
        RecordCodecBuilder.create(
            instance -> instance.group(Codec.unboundedMap(Codec.INT, Vector3fCodec.CODEC)
                .fieldOf("bone")
                .forGetter((AnimationBone ab) -> ab.keyframeMap))
            .apply(instance, AnimationBone::new)
        );
}
